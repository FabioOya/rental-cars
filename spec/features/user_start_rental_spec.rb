...
feature 'User start rental' do
  scenario 'successfully' do
    ...
    # user = create(:user, email: 'test@test.com.br') #Essa linha pode ser retirada login_helper
    # user = User.create!(email: 'test@test.com.br', password: '12345678')
    user = user_login # user_login metodo no modulo, spec/support/login_helper
    #login_as user, scope: :user #Essa linha pode ser tirada login_helper
