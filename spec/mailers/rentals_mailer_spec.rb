...
describe RentalsMailer do
  context '#scheduled' do
    ...
    it 'renders subject' do
      # rental = create(:rental)#Primeira forma de fazer #caso faça o teste com let essas linhas podem ser retiradas
      # mail = RentalsMailer.scheduled(rental)#Primeira forma de fazer #caso faça o teste com let essas linhas podem ser retiradas

      # mail = RentalsMailer.with(rental:rental).scheduled  #Segunda forma de fazer
